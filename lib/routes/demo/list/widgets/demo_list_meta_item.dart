...
class DemoListMetaItem extends StatelessWidget {
  ...
  ///
  /// [repo] 表示当前条目展示的仓库对象。
  const DemoListMetaItem({super.key, required this.repo});
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _MetaChip(icon: Icons.code, text: repo.language ?? '--'),
              _MetaChip(
                icon: Icons.star_outline,
                text: '${repo.stargazers_count}',
              ),
              _MetaChip(icon: MyIcons.fork, text: '${repo.forks_count}'),
              _MetaChip(icon: Icons.update, text: repo.updated_at),
            ],
          ),
        ],
      ),
